...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  // void _handleLunarDateChanged(NewLunar date) {
  //   setState(() {
  //     _selectedDate.value = date.toDateTime();
  //   });
  // }
  ...
  Widget build(BuildContext context) {
    ...
    CalendarDatePicker calendarDatePicker() {
      return CalendarDatePicker(
        ...
        //isLunarDay: widget.isLunarDay,
      );
    }
    //
    // LunarCalendarDatePicker lunarCalendarDatePicker() {
    //   return LunarCalendarDatePicker(
    //     key: _calendarPickerKey,
    //     initialDate:
    //         NewLunar(createdFromSolar: true, date: _selectedDate.value),
    //     firstDate: NewLunar(createdFromSolar: true, date: widget.firstDate),
    //     lastDate: NewLunar(createdFromSolar: true, date: widget.lastDate),
    //     currentDate: NewLunar(createdFromSolar: true, date: widget.currentDate),
    //     onDateChanged: _handleLunarDateChanged,
    //     selectableDayPredicate: widget.selectableDayPredicate,
    //     initialCalendarMode: widget.initialCalendarMode,
    //     isLunarDay: widget.isLunarDay,
    //   );
    ...
    final Widget header = _DatePickerHeader(
      ...
      titleText: widget.isLunarDay ? 'Âm lịch' : 'Dương lịch',
...
class _DatePickerHeader extends StatelessWidget {
  ...
  static const double _datePickerHeaderPortraitHeight = 80.0;
  ...
  Widget build(BuildContext context) {
    ...
    final double maxWidth =
        MediaQuery.orientationOf(context) == Orientation.landscape
            ? _maxCalendarWidthLandscape
            : _maxCalendarWidthPortrait;
    final DateTime dayDisplay = widget.isLunarDay
        ? Lunar(createdFromSolar: true, date: widget.displayedMonth)
            .toDateTime()
          ...
          child: Padding(
            ...
            child: Align(
              ...
              child: ExcludeSemantics(
                child: Text(
                  localizations.formatMonthYear(dayDisplay),
...
class _DayItemState extends State<_DayItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final Lunar lunar = Lunar(createdFromSolar: true, date: widget.day);

    final DateTime day = widget.isLunarDay
        ? DateTime(lunar.year, lunar.month, lunar.day)
        : widget.day;

    final String dayText = localizations.formatDecimal(day.day);
    ...
    String semanticLabel =
        '$dayText, ${localizations.formatFullDate(day)}$semanticLabelSuffix';
